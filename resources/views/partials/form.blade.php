<section class="p-4 flex justify-center items-center">
    <div class="w-full min-h-60 bg-orange-500 rounded-xl shadow-xl p-4 flex justify-center items-center">
        ...
        <form method="post" action="{{ route('sendmail') }}" class="w-1/2">
                ...
                <button type="submit" class="text-white bg-orange-500 hover:bg-orange-700 border transition-all border-white shadow-sm focus:ring-4 focus:outline-none font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center">Enviar</button>	
        </form>
    </div>
</section>