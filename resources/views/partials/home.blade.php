@if(isset($properties[0]))
    <div class="swiper w-full h-screen" id="slide-home">
            ...
            <div class="swiper-slide">
                <div class="relative h-[31rem] w-full rounded-2xl shadow-lg overflow-hidden">
                    ...
                    <div class="absolute bottom-10 left-10 z-20 text-white">
                        ...
                        <p class="mt-2">{{ $property->project }}</p>
...
@else
<section class="w-full min-h-screen relative flex justify-start items-end px-12 py-10 pb-5">
