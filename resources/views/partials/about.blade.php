<section class="relative w-full min-h-screen flex">
    <div class="relative w-1/3 min-h-screen">
        <img src="{{ asset('storage/img/rio-de-janeiro.jpg') }}" alt="Corretor Anderson" class="absolute w-full h-full left-0 top-0 object-cover z-0">
    </div>
    <div class="w-2/3 p-4 bg-orange-500 text-white flex items-start justify-center flex-col">
        <h4 class="font-light text-4xl"><span>AJF</span> Imóveis</h4>
        <h2 class="font-semibold text-2xl mb-2">Anderson Justino Ferreira</h2>
        ...
        <h4 class="mt-2 font-bold text-2xl">CRECI 35113-RJ</h4>
    </div>
</section>